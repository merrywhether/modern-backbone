...
},{"backbone":1,"underscore":12}],14:[function(require,module,exports){
'use strict';
...
var footerViewTemplate = require('./templates/footer.hbs'),
    navItemViewTemplate = require('./templates/navItem.hbs');

var events = require('./events');

var NavItem = (function (_Backbone$Model) {
  function NavItem() {
  ...
  _inherits(NavItem, _Backbone$Model);

  _createClass(NavItem, [{
    key: 'initialize',
    value: function initialize(options) {
      _get(Object.getPrototypeOf(NavItem.prototype), 'initialize', this).call(this, options);
      this.listenTo(events, 'nav', this.toggleActive);
    }
  }, {
    key: 'toggleActive',
    value: function toggleActive(target) {
...
var NavItemView = (function (_Backbone$View) {
  ...
  _inherits(NavItemView, _Backbone$View);

  _createClass(NavItemView, [{
    key: 'initialize',
    value: function initialize(options) {
      _get(Object.getPrototypeOf(NavItemView.prototype), 'initialize', this).call(this, options);
...
var NavItemList = (function (_Backbone$Collection) {
  function NavItemList() {
    _classCallCheck(this, NavItemList);

    if (_Backbone$Collection != null) {
      _Backbone$Collection.apply(this, arguments);
    }
  }

  _inherits(NavItemList, _Backbone$Collection);

  _createClass(NavItemList, [{
    key: 'initialize',
    value: function initialize(models, options) {
      this.model = NavItem;
      _get(Object.getPrototypeOf(NavItemList.prototype), 'initialize', this).call(this, models, options);
    }
  }]);
...
var FooterView = (function (_Backbone$View2) {
  function FooterView() {
  ...
  _inherits(FooterView, _Backbone$View2);

  _createClass(FooterView, [{
    key: 'initialize',
    value: function initialize(options) {
      _get(Object.getPrototypeOf(FooterView.prototype), 'initialize', this).call(this, options);
      this.collection = new NavItemList([{ title: 'Home', target: 'home' }, { title: '1: Set-up', target: 'setup' }, { title: '2: Views', target: 'views' }, { title: '3: Models', target: 'models' }, { title: '4: Events', target: 'events' }]);
    }
  }, {
    key: 'render',
    value: function render() {
      this.$el.html(footerViewTemplate());
      var $list = this.$el.find('#nav-list');
...
},{"./events":13,"./templates/footer.hbs":18,"./templates/navItem.hbs":22,"backbone":1}],15:[function(require,module,exports){
'use strict';
...
var headerViewTemplate = require('./templates/header.hbs');

var HeaderView = (function (_Backbone$View) {
  function HeaderView() {
  ...
  _inherits(HeaderView, _Backbone$View);
...
},{"./templates/header.hbs":19,"backbone":1}],16:[function(require,module,exports){
'use strict';
...
var MainView = (function (_Backbone$View) {
  ...
  _createClass(MainView, [{
    ...
    key: 'updateTemplate',
    value: function updateTemplate(target) {
...
var HandlebarsCompiler = require('hbsfy/runtime');
module.exports = HandlebarsCompiler.template({"compiler":[6,">= 2.0.0-beta.1"],"main":function(depth0,helpers,partials,data) {
    return "<div class='navbar-fixed'>\n  <nav class='top-nav'>\n    <div class='container'>\n      <div class='nav-wrapper'>\n        <a href='/' class='brand-logo center hide-on-small-only'>Modern Backbone</a>\n        <a href='/' class='brand-logo center hide-on-med-and-up'>MB</a>\n      </div>\n    </div>\n  </nav>\n</div>\n";
},"useData":true});
...
var AppRouter = (function (_Backbone$Router) {
  ...
  _createClass(AppRouter, [{
    key: 'initialize',
    value: function initialize(options) {
      _get(Object.getPrototypeOf(AppRouter.prototype), 'initialize', this).call(this, options);
      this.route('*path', 'homeRedirect');
      this.route('', 'home');
      this.route('setup.html', 'setup');
    ...
    key: 'homeRedirect',
    value: function homeRedirect(options) {
      Backbone.history.navigate('', { trigger: true });
    }
  }, {
    key: 'home',
    value: function home(options) {
      _events.trigger('nav', 'home');
      this.mainView.render('home');
    }
  }, {
    key: 'setup',
    value: function setup(options) {
      _events.trigger('nav', 'setup');
      this.mainView.render('setup');
    }
  }, {
    key: 'views',
    value: function views(options) {
      _events.trigger('nav', 'views');
      this.mainView.render('views');
    }
  }, {
    key: 'models',
    value: function models(options) {
      _events.trigger('nav', 'models');
      this.mainView.render('models');
    }
  }, {
    key: 'events',
    value: function events(options) {
      _events.trigger('nav', 'events');
...
},{"./events":13,"./footer":14,"./header":15,"./main":16,"backbone":1,"hbsfy/runtime":10,"jquery":11}]},{},[25]);
